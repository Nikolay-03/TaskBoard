...
export const useAddBoardToFavorites = () =>
	createMutation<void, Error, number, OptimisticContext>(() => ({
...
export const useDeleteBoardFromFavorites = () =>
	createMutation<void, Error, number, OptimisticContext>(() => ({
